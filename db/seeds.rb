...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "Dark Souls III Soundtrack OST - Soul of Cinder", description: "Dark Souls 3 Official OST", user_id: 2)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "Maple Story", description: "Maple Sit-tory dance", user_id: 3)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "can I get a bowl of that chili", description: 'wake up cole', user_id: 4)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "can I get a bowl of that chili", description: 'wake up cole', user_id: 6)
file = open("https://yootoob-seeds.s3-us-west-1.amazonaws.com/can+i+get+a+bowl+of+that+chili.mp4")
video.video.attach(io: file, filename: "can i get a bowl of that chili.mp4")

user = User.create(username: 'Gone Viral', password: 'Gone Viral')
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "It's just a frog...", description: 'No Description', user_id: 7)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: 'Hot dogs', description: 'I love you Dougie', user_id: 8)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: 'You may enter', description: 'That poor kid', user_id: 9)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "The Big Bouncing Inflatable Green Ball", description: "I made this a long time ago, completely forgot about it. P.S. I was totally gonna do the next one spoofing Oxyclean, can't do that anymore. R.I.P. Billy Mays.", user_id: 10)
...
user.profile_picture.attach(io: File.open(File.join(Rails.root, "app/assets/images/signin.jpeg")), filename: "default_profile_pic.jpeg")
video = Video.create(title: "Loudest Purring Cat - Guinness World Records", description: "Yeaight", user_id: 11)
